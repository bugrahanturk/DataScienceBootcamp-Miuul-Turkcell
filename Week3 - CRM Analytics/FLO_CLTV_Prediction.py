...
# GÖREV 3: BG/NBD, Gamma-Gamma Modellerinin Kurulması, CLTV'nin hesaplanması
           # 1. BG/NBD modelini fit ediniz.
                ...
                # c. 3. ay ve 6.aydaki en çok satın alım gerçekleştirecek 10 kişiyi inceleyeniz. Fark var mı?
...
# CLTV değerlerini standarlaştırıp scale_cltv değişkeni oluşturunuz.
...
# 2. CLTV skorlarına göre müşterileri 4 gruba ayırmak mantıklı mıdır? Daha az mı ya da daha çok mu olmalıdır. Yorumlayınız.
cltv_df[['cltv_segment',"exp_sales_3_month", "exp_sales_6_month", "exp_average_value", "scaled_cltv"]].groupby("cltv_segment").agg(["median", "count"])

#5'e bolersek
cltv_df["cltv_segment"] = pd.qcut(cltv_df["scaled_cltv"], 4, labels=['E',"D", "C", "B", "A"])
cltv_df[['cltv_segment',"exp_sales_3_month", "exp_sales_6_month", "exp_average_value", "scaled_cltv"]].groupby("cltv_segment").agg(["median", "count"])
...
###############################################################
# GÖREV 5: Tüm süreci fonksiyonlaştırınız.(BONUS)
###############################################################
...
def create_cltv_df(dataframe):
    ...
    # CLTV standartlaştırma ve segmentleme
    scaler = MinMaxScaler(feature_range=(1, 100))
    scaler.fit(cltv_df[["cltv"]])
    cltv_df["scaled_cltv"] = scaler.transform(cltv_df[["cltv"]])
    cltv_df["cltv_segment"] = pd.qcut(cltv_df["scaled_cltv"], 4, labels=["D", "C", "B", "A"])
